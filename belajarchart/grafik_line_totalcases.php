...
while($row = mysqli_fetch_array($country)){
	...
	// Mengambil data totalcases pada tb_covid
	$query = mysqli_query($koneksi,"SELECT totalcases FROM tb_covid WHERE id='".$row['id']."'");
...
<html>
<head>
	<title>Line Chart Covid Total Cases</title>
